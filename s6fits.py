...
class s6hits_t(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["time"] = _s6fits.s6hits_t_time_set
    __swig_getmethods__["time"] = _s6fits.s6hits_t_time_get
    if _newclass:time = _swig_property(_s6fits.s6hits_t_time_get, _s6fits.s6hits_t_time_set)
    ...
    if _newclass:nhits = _swig_property(_s6fits.s6hits_t_nhits_get, _s6fits.s6hits_t_nhits_set)
...
class s6dataspec_t(_object):
    ...
    if _newclass:sortby_freq = _swig_property(_s6fits.s6dataspec_t_sortby_freq_get, _s6fits.s6dataspec_t_sortby_freq_set)
